...
/*   Updated: 2019/07/12 16:14:44 by jallen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**	4: IND 5: DIR_LAB4_bytes 6: inst 7: LABEL
**	8: comment 9: IND_LAB 15: DIR_LAB2Bytes
*/

void				readfile(int fd, char **line);
t_par				*ingest_file(char *file, int row);
void				encoding(t_par *lst, t_inst *inst);
void				to_binary(t_par *lst, char *src, t_header *h, char *name);
